...
rad= st.sidebar.radio('Chọn mục:', ['Trang chủ','Giới thiệu','Tỷ lệ thanh khoản', 'Tỷ suất tự tài trợ', 'Tỷ lệ nợ xấu', 'Lợi nhuận', 'Tăng trưởng tín dụng', 'ROA - ROE', 'Thu nhập của ngân hàng', 'Thu nhập từ dịch vụ', 'Tiền gửi ngân hàng'])
...
with model_training:
    if rad == 'Tỷ lệ thanh khoản':
        ...
        with st.expander("Đánh giá:"):
            ...
            thanh khoản tốt cho các ngân hàng. Trong ai quý đầu năm 2021, tuy có ảnh hưởng khá nặng của
    ...
    if rad == 'Tỷ lệ nợ xấu':
        ...
        with st.expander("Đánh giá:"):
            ...
            cho thấy triển vọng của nợ xấu đã bắt đầu tăng trong năm 2020. Tỷ lệ nợ xấu trung bình tăng của
    ...
    if rad== 'ROA - ROE':
        ...
        with st.expander("Đánh giá:"):
            ...
            cho mức ROE thấp là do chiến lược của ngân hàng tập trung vào hoạt động cho vay doanh nghiệp,12
