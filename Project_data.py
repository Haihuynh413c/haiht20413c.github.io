...
rad= st.sidebar.radio('Chọn mục:', ['Trang chủ','Giới thiệu','Tăng trưởng tín dụng', 'Tỷ lệ nợ xấu', 'Tiền gửi ngân hàng', 'Tỷ lệ thanh khoản', 'Tăng trưởng tín dụng', 'Lợi nhuận', 'ROA - ROE', 'Tỷ suất tự tài trợ', 'Thu nhập của ngân hàng', 'Thu nhập từ dịch vụ', 'Lời cảm ơn'])
